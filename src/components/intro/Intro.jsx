    ...
    <div className="i">
      <div className="i__left">
        <div className="i__left-wrapper">
          ...
          <h1 className="i__name">Raghava</h1>
          <div className="i__title">
            <div className="i__title-wrapper">
              <div className="i__title-item">Web Developer</div>
              <div className="i__title-item">Javascript Developer</div>
              <div className="i__title-item">ReactJS Developer </div>
              <div className="i__title-item">NodeJS Developer</div>
            </div>
          </div>
          <p className="i__desc">
